    ...
    content: [
      {
        ...
        content: {
          ...
          right: {
            type: 'text',
            content: {
              text: '**Проанализировала существующие сервисы/молодежные подписки**\nв банковских продуктах\n— вместе с аналитиком и маркетологами составили список сервисов-конкурентов; изучали как рынок РФ, так и зарубежные практики;\n\n**Нашла референсы под нашу тематику**\n— взяла за основу айдентику и визуальный язык Альфа-Банка, чтобы подписка не выбивалась из общего стиля, но было заметно, что она для молодежи (сделала цветовые акценты и использовала 3D);\n\n**Прописала гипотезы**\n— провела кастдевы, что помогло определиться с функционалом\n\n**Составила CJM**\n— прописала сценарии и эмоции пользователей\n\n**Отрисовала макеты**\n— подготовила вайрфреймы, финальные макеты и кликабельный прототип, чтобы записать видео и продемонстрировать функционал основных фич;',
              align: 'left',
            },
          },
        },
      ...
      },
      {
        ...
        content: {
          ...
          right: {
            type: 'text',
            content: {
              text: '**Изучила специфику TG mini apps**\n— посмотрела UI-kit, основные цвета и шрифты, ограничения;\n\n**Подготовила ряд идей по пользовательским сценариям\nи функционалу**\n— прописала гипотезы и подтвердила их на кастдеве\n— собрала опыт с этого проекта в статью на Хабре «Геймификация и дизайн: как мотивировать пользователя пройти опрос»;\n\n**Подготовила макеты для разработки**\n— и собрала UI-kit\n\n**Взяла на себя роль тимлида команды дизайна**\n— команда дизайна на данный момент состоит из 3 человек',
              align: 'left',
            },
          },
        },
