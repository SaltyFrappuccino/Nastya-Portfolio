    ...
    content: [
      {
        ...
        content: {
          title: 'Что сделала',
          text: 'Проанализировала существующие сервисы/молодежные подписки в банковских продуктах - вместе с аналитиком и маркетологами составили список сервисов - конкурентов - изучали как рынок РФ, так и зарубежные практики;\n\nНашла референсы под нашу тематику - взяла за основу айдентику и визуальный язык Альфа-Банка, чтобы подписка не выбивалась из общего стиля, но было заметно, что она для молодежи (сделала цветовые акценты и использовала 3д);\n\nПрописала гипотезы - провела кастдевы, что помогло определиться с функционалом\n\nСоставила CJM - прописала сценарии и эмоции пользователей\n\nОтрисовала макеты - подготовила вайрфреймы, финальные макеты и кликабельный прототип, чтобы записать видео и продемонстрировать функционал основных фич;',
          align: 'left',
        },
      },
      {
    ...
    content: [
      {
        ...
        content: {
          title: 'Что сделала',
          text: 'Изучила специфику TG mini apps - посмотрела ui-kit, основные цвета и шрифты, ограничения;\n\nПодготовила ряд идей по пользовательским сценариям и функционалу - прописала гипотезы и подтвердила их на кастдеве\n- собрала опыт с этого проекта в статью на Хабре "Геймификация и дизайн: как мотивировать пользователя пройти опрос";\n\nПодготовила макеты для разработки - и собрала UI-kit\n\nВзяла на себя роль тимлида команды дизайна - команда дизайна на данный момент состоит из 3х человек',
          align: 'left',
        },
      },
      {
    ...
    content: [
      {
        ...
        content: {
          title: 'Что сделала',
          text: 'Изучила специфику работы маркетплейсов и продажи на них;\n\nПровела полное исследование рынка (в т.ч. селлеры и одиночные продавцы) для выбора наиболее удобного UX и необходимого функционала в MVP;\n\nПодготовила графические материалы (баннеры);\n\nРазработала дизайн нового для маркетплейсов функционала, аналога которому еще нет на рынке;\n\nПодготовила макеты для разработки для разного типа доступов: мобильное приложение + десктоп и отдельным сервисом админку.',
          align: 'left',
        },
      },
      {
